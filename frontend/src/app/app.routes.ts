...
export const routes: Routes = [
  ...
  { path: 'login', component: SignInComponent },
  {
    ...
    children: [
      ...
      { path: 'sales/quotations/:id', loadComponent: () => import('./features/sales/sales-workspace.component').then((module) => module.SalesWorkspaceComponent) },
      ...
      { path: 'procurement/supplier-returns', loadComponent: () => import('./features/procurement/supplier-return-workspace.component').then((module) => module.SupplierReturnWorkspaceComponent) },
      { path: 'procurement/supplier-returns/new', loadComponent: () => import('./features/procurement/supplier-return-workspace.component').then((module) => module.SupplierReturnWorkspaceComponent) },
      { path: 'procurement/supplier-returns/:id', loadComponent: () => import('./features/procurement/supplier-return-workspace.component').then((module) => module.SupplierReturnWorkspaceComponent) },
