...
namespace MiniErp.Infrastructure.Persistence.Migrations.Sales
{
    ...
    [Migration("20260905204444_MESP138Hold3FinanceEffectAuthority")]
    partial class MESP138Hold3FinanceEffectAuthority
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("MiniErp.Infrastructure.Persistence.Modules.Sales.SalesCustomerReturnLineEntity", b =>
                {
                    ...
                    b.HasIndex("TenantId", "CustomerReturnId", "OrderLineId")
                        .IsUnique();

                    b.HasIndex("TenantId", "DeliveryId", "OrderLineId");

                    b.ToTable("SalesCustomerReturnLines", "sales");
                });
