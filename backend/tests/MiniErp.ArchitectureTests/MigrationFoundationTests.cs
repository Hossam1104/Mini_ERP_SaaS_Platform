...
public sealed class MigrationFoundationTests
{
    ...
    public void Migration_module_does_not_take_cross_module_persistence_dependencies()
    {
        ...
        foreach (var file in files)
        {
            ...
            var economicCoordinator = Path.GetFileName(file) is "MigrationInventoryOpeningExecutionCoordinator.cs" or "MigrationArOpeningExecutionCoordinator.cs" or "MigrationApOpeningExecutionCoordinator.cs" or "MigrationCashBankOpeningExecutionCoordinator.cs";
