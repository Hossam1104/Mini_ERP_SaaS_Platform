...
|---|---|---|---|
| 1 | Slice 11 evidence Bugs MESP-156..160 (#272–#276), then an Opus re-review of Slice 11 under MESP-150 (#265) | Luna 6 / xhigh | Test-only fixes: R04/R05 exact mapping, R07 subsidiary-to-GL reconciliation, R12 fingerprint and approval staleness, R18 no-activation oracle, R20/A5 real concurrency and version conflict. The prompt is in `TASK.md`. |
